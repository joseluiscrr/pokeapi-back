...
const { Pokemon, Type, Abilitie } = sequelize.models;

Pokemon.belongsToMany(Type, { through: "pokemon-type"});
Type.belongsToMany(Pokemon, { through: "pokemon-type"});
Pokemon.belongsToMany(Abilitie, { through: "pokemon-abilitie"});
Abilitie.belongsToMany(Pokemon, { through: "pokemon-abilitie"});
